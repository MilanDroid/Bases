...
VAR_ALIMENTOS IN VARCHAR2, VAR_NUTRIENTES IN VARCHAR2) IS
...
INSERT INTO TBL_DIETAS(ID_DIETA, NOMBRE_DIETA, OD_DIETA, ALIMENTOS, NUTRIENTES)
VALUES(103, VAR_NOMBRE_DIETA, VAR_OD_DIETA, VAR_ALIMENTOS, VAR_NUTRIENTES);

INSERT INTO TBL_ANIMALES (ID_ANIMAL, OD_ANIMAL, TIPO_ANIMAL, ID_DIETA) 
VALUES(VAR_ID_ANIMAL, VAR_OD_ANIMAL, VAR_TIPO_ANIMAL, 103);

INSERT INTO TBL_HISTORIAL_DIETA (ID_ANIMAL, ID_DIETA, FECHA_INICIO, FECHA_FINAL, OD_HISTORIAL_DIETA)
VALUES (VAR_ID_ANIMAL, 103, SYSDATE, NULL, VAR_OD_HISTORIAL_DIETA);
END;
...
CREATE OR REPLACE FORCE VIEW V_DIETAS AS 
...
CREATE OR REPLACE FORCE VIEW V_INF_ANIMALES AS 
...
CREATE OR REPLACE FORCE VIEW V_NECESIDADES AS 
